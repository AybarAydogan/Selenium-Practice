...
public class P01 {
    public static void main(String[] args) {
        ...
        driver.findElement(By.id("firstName")).sendKeys("Aybar");
        // driver.findElement(By.xpath("input[@id='firstName']")).sendKeys("Tarık");
        driver.findElement(By.id("lastName")).sendKeys("Aydoğan");
        driver.findElement(By.id("email")).sendKeys("aybar@gmail.com");
        driver.findElement(By.xpath("//input[@type='tel']")).sendKeys("905555554422");
        driver.findElement(By.cssSelector("input[id='age']")).sendKeys("19");
